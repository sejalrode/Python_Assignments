...
def MarvellousKNN(datasetpath):
    ...
    print(test_df)
    print(line)
    print("Predictions saved to 'Diabetes_Predictions_KNN.csv'")
    test_df.to_csv("Diabetes_Predictions_KNN.csv", index=False)

def main():
    MarvellousKNN("diabetes.csv")
